  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `recent_files` (`uri` TEXT NOT NULL, `name` TEXT NOT NULL, `type` TEXT NOT NULL, `size` INTEGER NOT NULL, `lastOpened` INTEGER NOT NULL, PRIMARY KEY(`uri`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ad93239ce7835368ce3510b90fb45cdd')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsRecentFiles.put("uri", new TableInfo.Column("uri", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsRecentFiles.put("lastOpened", new TableInfo.Column("lastOpened", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoRecentFiles.equals(_existingRecentFiles)) {
          return new RoomOpenHelper.ValidationResult(false, "recent_files(com.docviewer.allinone.data.db.RecentFileEntity).\n"
                  + " Expected:\n" + _infoRecentFiles + "\n"
                  + " Found:\n" + _existingRecentFiles);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "ad93239ce7835368ce3510b90fb45cdd", "7cd56a13c417534fda6ab41d293c5799");
